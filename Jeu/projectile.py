...
class projectile :
    ...
    def routine(self):
        #On vérifie que le projectile est toujours dans le canevas
    ...
    # --- Si besoin, ces fonctions permettent de récupérer/modifier la position du projectile ---
    def get_pos(self):
    ...
    def friendlyroutine(self):
        ...
        if self.__posY < 640 and self.__posY > 0: 
            ...
            #Le projectile est hors du canevas : on l'efface !
            self.__canevas.delete(self.__rectangle)
    ...
    #Cette fonction permet de détecter une colision avec les entités de type Bonus        
    ...
    #Cette fonction permet de détecter une colision avec les entités de type Boss
